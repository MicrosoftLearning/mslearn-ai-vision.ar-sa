...
1. في تعليمة Visual Studio البرمجية، اطلع على صور التدريب في مجلد**Labfiles/03-object-detection/training-images** حيث قمت باستنساخ المستودع. يحتوي هذا المجلد على صور للفاكهة.
...
8. عند الانتهاء من وضع علامات على الصورة الأخيرة، أغلق محرر ** تفاصيل الصورة**. في صفحة **تدريب الصور**، ضمن **العلامات**، حدد **الصور ذات العلامات** لمشاهدة جميع الصور ذات العلامات:
...
4. في تعليمة Visual Studio البرمجية، ضمن مجلد**Labfiles/03-object-detection**، قم بتوسيع مجلد** C-Sharp**أو **Python**استنادًا إلى تفضيلات اللغة.
...
الآن بعد أن قمت بتمييز الصور في مشروعك، فأنت جاهز لتدريب نموذج. أنت
...
1. في تعليمة Visual Studio البرمجية استعرض للوصول إلى مجلد**Labfiles/03-object-detection** وفي مجلد الغة المفضلة لديك (**C-Sharp** أو **Python**)، قم بتوسيع مجلد**test-detector**.
