---
lab:
  title: تصنيف الصور باستخدام Azure AI Custom Vision (قديم)
---
...
1. في تعليمة Visual Studio البرمجية، اطلع على صور التدريب في مجلد **07-custom-vision-image-classification/training-images** حيث قمت باستنساخ المستودع. يحتوي هذا المجلد على مجلدات فرعية من صور التفاح والموز والبرتقال.
...
3. في مدخل Custom Vision، أنشئ مشروعًا جديدًا بالإعدادات التالية:
    ...
    - **المَجالات**: الغذاء
4. في المشروع الجديد، انقر فوق **\[+\]إضافة صور**، واختر كافة المجلد الموجودة في مجلد **training-images/apple** الذي قمت بعرضه مسبقًا. ثم قم بتحميل ملفات الصور، مع تحديد العلامة *تفاحة*، على النحو التالي:
